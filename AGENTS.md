...
no consumer at any version. hive-gen's eight card wrappers were outside them until 0.7.0, which
[docs/reference/hive-gen.md](docs/reference/hive-gen.md) records. Code a consumer is meant to RUN
