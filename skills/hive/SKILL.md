...
- **When you know the client, pass it to `find_concepts`**: `client` adds that client's own memory and issue cards to the search, and only that client's. Without it, search covers shared cards only.
