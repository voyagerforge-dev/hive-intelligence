...
def _settings_from_env_example(tmp_path):
...
def test_a_copied_env_example_leaves_the_corpus_settings_required_and_unset(tmp_path):
    ...
    s = _settings_from_env_example(tmp_path)
    pairs = _pairs()
...
def test_a_copied_env_example_does_not_contradict_the_code_defaults(tmp_path):
...
def test_env_example_matches_the_shipped_model_defaults(tmp_path):
    ...
    s = _settings_from_env_example(tmp_path)
    for field in ("select_model", "answer_model", "judge_model"):
