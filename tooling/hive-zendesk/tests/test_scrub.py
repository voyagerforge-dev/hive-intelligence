...
from hivezendesk.scrub import known_values, leaks, scrub_text
...
# --- SA ID detection must not fire on WIDGETS identifiers ---------------------------------
# Illustrative subjects: "IN-000000 EXDC BENCH Wave Abort <13 digits> - urgent issue" and
...
def test_a_wms_identifier_is_not_mistaken_for_an_sa_id():
    ...
    assert "sa_id" not in leaks("BENCH Wave Abort 9999999999999 - urgent", set())
