...
# Functional areas → the exact `topic:` frontmatter values the curator assigned. Run hivegen
...
AREAS: dict[str, tuple[str, ...]] = {
    ...
    # (see hiveprep/retopic classifier). Guide-overview cards complement the FS concept cards.
