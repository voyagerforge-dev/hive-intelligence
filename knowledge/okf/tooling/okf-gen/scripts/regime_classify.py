# knowledge/okf/tooling/okf-gen/scripts/regime_classify.py
...
from okfgen.classify_regime import classify_card_regime
from okfgen.config import get_settings  # existing okfgen env/config loader (pydantic-settings)
