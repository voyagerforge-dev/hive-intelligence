...
_SYSTEM = (
    ...
    "Wave/Replenishment functional area, propose a concise taxonomy of distinct CONCEPTS they "
    "cover. Reply with ONLY a JSON object: {\"concepts\": [{\"id\", \"title\", \"description\", "
    "\"aliases\"}]}. id is a short kebab-case slug; aliases is a list of alternative terms. "
    "Prefer fewer, well-bounded concepts over many narrow ones."
)
