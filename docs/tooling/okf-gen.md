...
*Stage 2 of the OKF pipeline: distills atomic markdown into cross-linked concept cards, and hosts the post-promote + corrections/memory authoring scripts. Conceptual model in [OKF-Pipeline.md §4](../OKF-Pipeline.md#4-stage-2-card-creation-hivegen).*

**Tooling reference:** [Hub](README.md) · [hive-prep](hive-prep.md) · **hive-gen** · [hive-serve](hive-serve.md) · [hive-dbparse](hive-dbparse.md) · [hive-author](hive-author.md) · [hive-zendesk](hive-zendesk.md) · [Architecture & Concepts](../OKF-Pipeline.md)
